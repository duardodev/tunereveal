export default function Illustration() {
  ...
  return (
    <>
      <svg
        className="pointer-events-none absolute left-1/2 -z-10 -translate-x-1/2 md:-translate-x-full"
      ...
      >
        <g filter="url(#illf-a)" opacity=".32">
          <path fill="url(#ill-b)" fillRule="evenodd" d="m64-42 344 212-166 188L64-42Z" clipRule="evenodd" />
        </g>
        <g filter="url(#illf-c)" opacity=".32">
          <path fill="url(#ill-d)" fillRule="evenodd" d="m64-42 344 212-200-67L64-42Z" clipRule="evenodd" />
        </g>
        <defs>
      ...
      >
        <g filter="url(#ill2-a)" opacity=".2">
          <path fill="url(#ill2-b)" fillRule="evenodd" d="m88 88 344 212-166 188L88 88Z" clipRule="evenodd" />
        </g>
        <defs>
